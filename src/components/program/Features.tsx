            ...
            return (
              <Card key={idx} className="border-none shadow-xl shadow-primary/5 hover:shadow-2xl transition-all duration-500 group rounded-[2rem]">
                <CardContent className="pt-10 pb-10 px-8">
                  <div className={`bg-primary/5 text-primary w-16 h-16 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500`}>
