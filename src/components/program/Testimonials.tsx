          ...
          <Card key={idx} className="h-full glass-card hover:-translate-y-2 transition-all duration-500 rounded-[3rem] overflow-hidden group flex flex-col border-white/5">
            ...
            <CardContent className="p-12 flex flex-col flex-grow relative">
              ...
              <div className="flex-grow relative z-10">
                <p className="text-white/90 text-2xl font-medium leading-relaxed italic mb-12">
                  "{t.content}"
                </p>
              </div>
              ...
              <div className="mt-auto pt-10 border-t border-white/5 flex items-center justify-between">
                <div>
                  {t.name ? (
                    <h4 className="font-headline font-bold text-white text-xl tracking-tight uppercase">{t.name}</h4>
                  ) : (
                    <h4 className="font-headline font-bold text-white text-xl tracking-tight uppercase">Anonymous Alumni</h4>
                  )}
                  {t.role && (
